...
import { Role, Permission, ROLE_PERMISSIONS, getRoleLevel, hasPermission, hasRequiredRole, normalizeRole } from '@/components/admin/role-guard'
...
function calculatePermissions(role: Role): Permissions {
  ...
  return {
    ...
    canViewAdvancedSettings: rolePermissions.includes('view_audit_logs') || rolePermissions.includes('manage_settings'),
...
export function usePermissions() {
  ...
  const canPerformAction = (requiredRole: Role | Role[], requiredPermission?: Permission | Permission[]) => {
