...
from api.core.deps import get_current_organization, get_current_active_user, get_db
...
async def update_lead_stage(
    ...
    **Required**: X-Org-Id header with valid organization ID
    """
    service = CRMLeadService(db)
    lead = await service.update_lead_stage(organization, lead_id, stage_data, UUID(str(current_user.id)))
