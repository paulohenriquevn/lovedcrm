...
class UserPreferences(Base):
    ...
    dashboard_layout = Column(String(20), default="default", nullable=False)  # default, compact, expanded
    ...
    profile_visibility = Column(String(20), default="organization", nullable=False)  # private, organization, public
