...
from sqlalchemy import UUID as SA_UUID, Column, DateTime, ForeignKey, String, Text
...
class Communication(Base):
    ...
    file_attachments = relationship(
        "FileAttachment", back_populates="communication", cascade="all, delete-orphan"
    )

    def __repr__(self):
        """Return string representation of Communication."""
