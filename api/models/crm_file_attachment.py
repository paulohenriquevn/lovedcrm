...
from sqlalchemy import UUID as SA_UUID, Boolean, Column, DateTime, ForeignKey, Integer, String, Text
...
class FileAttachment(Base):
    ...
    storage_type: StorageType = Column(
        String(20), nullable=False, default=StorageType.MINIO, index=True
    )
    is_encrypted: bool = Column(Boolean, nullable=False, default=True)

    # File metadata
    file_metadata: Dict[str, Any] = Column("metadata", JSONB, nullable=False, default=dict)
    ...
    def __repr__(self):
        """Return string representation of FileAttachment."""
    ...
    def set_thumbnail_path(self, thumbnail_path: str):
        ...
        self.update_metadata({"thumbnail_path": thumbnail_path, "has_thumbnail": True})
    ...
    def create_whatsapp_media(
        ...
        metadata = {"source": "whatsapp", "whatsapp_media_id": whatsapp_media_id}
    ...
    def create_email_attachment(
        ...
        metadata = {"source": "email", "email_attachment_id": email_attachment_id}
