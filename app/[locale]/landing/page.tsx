...
const ProblemSolutionSection = lazy(() => import('@/components/landing/problem-solution-section').then(mod => ({ default: mod.ProblemSolutionSection })))
const FeaturesSection = lazy(() => import('@/components/landing/features-section').then(mod => ({ default: mod.FeaturesSection })))
const SocialProofSection = lazy(() => import('@/components/landing/social-proof-section').then(mod => ({ default: mod.SocialProofSection })))
