  ...
  return (
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto">
        Identificamos os maiores desafios das agências digitais brasileiras 
        e criamos soluções específicas para cada um deles.
      </p>
    </div>
  )
}
  ...
  return (
    <div className="my-16 text-center">
      ...
      <p className="text-muted-foreground mt-6 mb-12 max-w-2xl mx-auto">
        Veja como o Loved CRM resolve cada problema específico da sua agência 
        com soluções práticas e comprovadas.
      </p>
    </div>
  )
}
    ...
    <div className="mt-16 text-center">
      <div className="bg-gradient-to-r from-primary/5 to-emerald-500/5 rounded-2xl p-8 max-w-4xl mx-auto border border-primary/10">
        <h3 className="text-2xl font-bold mb-4">
          Resultado: +186% de ROI em 6 meses
        </h3>
        <p className="text-muted-foreground mb-6">
          Agências que adotaram o Loved CRM relatam aumento significativo em 
          conversões, produtividade e satisfação da equipe.
        </p>
