/**
 * Hero Section Old Components - Extracted components for better maintainability
 * Reduces hero-section-old.tsx function complexity and improves code organization
 */
...
import { heroAnimations, buttonPressVariants, iconBounceVariants } from '@/hooks/use-scroll-animation'
...
export function HeroHeadingSection(): JSX.Element {
  return (
    <>
      <motion.h1 
...
export function HeroCTASection(): JSX.Element {
  return (
    <motion.div 
...
export function HeroTrustSection(): JSX.Element {
  return (
    <motion.div 
...
export { HeroDashboardSection } from './hero-dashboard-section'

export function HeroSocialProofSection({ imageLoading, handleImageLoad }: HeroSectionProps): JSX.Element {
  const logos = [
