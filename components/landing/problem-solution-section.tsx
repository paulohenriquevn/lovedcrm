...
const solutions = [
  {
    ...
    description: "Centralize todas as conversas profissionais em um único lugar, com histórico completo e distribuição automática.",
    features: [
  ...
  },
  {
    ...
    description: "Visualize todo o funil de vendas em tempo real, com métricas automáticas e insights acionáveis.",
    features: [
  ...
  },
  {
    ...
    description: "IA em português analisa conversas e gera resumos automáticos, além de automatizar tarefas repetitivas.",
    features: [
