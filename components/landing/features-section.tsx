...
const coreFeatures = [
  {
    ...
    description:
      'Pipeline otimizado para o processo de vendas das agências brasileiras. Arraste e solte leads entre estágios com facilidade.',
  ...
  },
  {
    ...
    description:
      'Integração nativa com WhatsApp Business API. Gerencie todas as conversas de clientes sem sair do CRM.',
  ...
  },
  {
    ...
    description:
      'IA treinada para agências brasileiras. Resumos automáticos de conversas, qualificação de leads e sugestões de próximas ações.',
...
const advancedFeatures = [
  {
    ...
    description:
      'Controle de permissões, distribuição de leads e acompanhamento de performance individual.',
  ...
  },
  {
    ...
    description:
      'Conformidade total com LGPD. Dados criptografados e políticas de retenção configuráveis.',
  ...
  },
  {
    ...
    title: 'App Mobile',
    description:
      'Acesse seu CRM de qualquer lugar. App nativo para iOS e Android com sincronização em tempo real.',
  ...
  },
  {
    ...
    description:
      'Ligue diretamente do CRM. Gravação automática de chamadas e integração com timeline.',
  ...
  },
  {
    ...
    description:
      'Gere propostas personalizadas baseadas no perfil do lead. Templates pré-aprovados para agilidade.',
    ...
    <Card className="bg-card border border-border shadow-sm">
      <CardContent className="p-8">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold text-foreground mb-2">Performance Comprovada</h3>
