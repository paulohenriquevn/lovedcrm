  ...
  return (
    <section className="bg-muted/50 px-6 py-16">
      <div className="container mx-auto max-w-6xl text-center">
        <h2 className="mb-12 text-3xl font-bold">Confiado por Agências Digitais em Todo Brasil</h2>
        ...
        <div className="grid gap-8 md:grid-cols-3 mb-12">
          ...
          <Card className="border-sector-cta/20">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-muted-foreground">Setup completo vs semanas dos concorrentes</p>
            </CardContent>
          </Card>
        </div>

        <blockquote className="text-lg italic text-muted-foreground mb-4 max-w-2xl mx-auto">
          &ldquo;Finalmente um CRM brasileiro que entende agências. Eliminamos 6 ferramentas e
          aumentamos nossa conversão em 400%. O WhatsApp nativo foi um game changer.&rdquo;
        </blockquote>
