      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            <h2 className="mb-4 text-3xl font-bold">Pipeline Visual com Drag & Drop Inteligente</h2>

            <p className="mb-6 text-lg text-muted-foreground">
              Funil drag-and-drop com mínimo 5 estágios configuráveis, filtros por origem,
              responsável, período e métricas de conversão por estágio em tempo real - tudo isolado
              por organização.
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span>
                  5+ estágios customizáveis (Lead → Contact → Proposal → Negotiation → Closed)
                </span>
              </li>
              <li className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-sector-trust flex-shrink-0" />
                    ...
                    <div key={stage} className="bg-gray-50 rounded p-2">
                      ...
                      <div className="space-y-1">
                        {Array.from({ length: i + 1 }, (_, j) => (
                          <div
                            key={`pipeline-lead-${stage}-item-${j + 1}`}
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            <h2 className="mb-4 text-3xl font-bold">WhatsApp Business API + Web API Dual</h2>

            <p className="mb-6 text-lg text-muted-foreground">
              Chat integrado com histórico completo, anexos (imagens, documentos, áudios), status de
              entrega e leitura, sincronização bidirecional - arquitetura dual provider única.
            </p>
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            <h2 className="mb-4 text-3xl font-bold">Lead Scoring Automático com IA</h2>
