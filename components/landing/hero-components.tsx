...
import { handleCreateOrganizationClick, handleDemoRequestClick, type ImageLoadingState, type ImageType } from './hero-helpers'
...
export function HeroDashboardMockupComponent({ 
  ...
  return <HeroDashboardMockup heroAnimations={heroAnimations} imageLoading={imageLoading} handleImageLoad={handleImageLoad} />
}
...
export function HeroSocialProof({ imageLoading, handleImageLoad }: HeroSocialProofProps): JSX.Element {
  const logos = [
