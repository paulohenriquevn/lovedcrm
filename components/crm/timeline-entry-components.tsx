...
export function EntryIcon({
  ...
  return (
    <div className={cn('flex items-center justify-center h-6 w-6 rounded-full', config.bgColor)}>
...
function LeadContextBadge({
  ...
  const hasLeadName =
    entry.leadName !== null && entry.leadName !== undefined && entry.leadName.length > 0
